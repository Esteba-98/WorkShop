        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mantenimientos_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "MantenimientoItems",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MantenimientoId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MantenimientoItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MantenimientoItems_Mantenimientos_MantenimientoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MantenimientoItems_MantenimientoId",
                table: "MantenimientoItems",
                column: "MantenimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_MantenimientoItems_ProductoId",
                table: "MantenimientoItems",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_Mantenimientos_ClienteId",
